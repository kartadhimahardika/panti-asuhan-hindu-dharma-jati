<nav x-cloak
    ...
    <!-- logo  -->
    <a href="{{ route('dashboard') }}" class="flex items-center p-2 space-x-3">
        <img src="{{ asset('logo.png') }}" alt="Logo Panti Asuhan" class="h-12 w-12 rounded-full object-contain">
        <div class="leading-tight">
            <span class="text-sm font-semibold text-neutral-900 dark:text-white">Panti Asuhan Hindu</span><br>
            <span class="text-xs font-semibold text-neutral-900 dark:text-white">Dharma Jati I</span>
        </div>
    </a>
